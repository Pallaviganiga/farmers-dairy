...
<form action="#" method="post">
	<div class="grid">
		<div class="form-group a">
			...
			<input id="name" type="text" value="<?php echo $name; ?>" readonly>
		</div>

		<div class="form-group">
			<label for="zip">Old Password</label>
			<input id="zip" type="text" value="<?php echo $password; ?>" readonly>
		</div>
		<div class="form-group">
			<label for="zip">New Password</label>
			<input id="zip" type="text" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
		</div>
		<div class="checkboxes">
			<div class="button-container">
				<button class="button" name="update" type="submit">Submit</button>
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update admin_log set password='".$name."'";
