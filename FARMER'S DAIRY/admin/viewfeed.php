                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">FeedBack Details</h5>
                        </div>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
								...
								<?php
								include 'config.php';
								$sql1="select feedback.*,dipo_reg.* from feedback inner join dipo_reg on feedback.dippoid=dipo_reg.email";
								...
								?>
									...
									<td><?php echo $ostar; ?>&nbsp;</td>
									<td><?php echo $dipponame; ?></td>
									</tr>
									   <?php
									}
								}
