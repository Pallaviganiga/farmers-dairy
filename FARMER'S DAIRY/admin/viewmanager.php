                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">View Manager Details</h5>
                        </div>
                            ...
                            <table class="table table-hover">
								...
								?>
                                    <tr>
										...
										<td><?php echo $ph_no ?></th>
										<td><?php echo $address ?></td>
										<td><form action="#" method="post">
									<div class="form-row">
									<div class="form-group col-md-2">
									<input type="text" name="mid[]" value="<?php echo $m_id; ?>" hidden="true">
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from add_manager where m_id='".$selectid."'";
