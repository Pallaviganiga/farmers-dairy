                       ...
                       <h5 class="mt-5">Staff Salary</h5>
                        ...
                        <form class="needs-validation" action="#" method="post">
                                    ...
                                    <select class="form-control" name="staffno" required onchange="this.form.submit();">
										...
										if($num1>0)
										{
											while($row1=mysqli_fetch_array($result1))
											{
												...
												$fname=$row1['fname'];
										?>
                                        <option value="<?php echo $staffno;?>"><?php echo $staffno;?>:&nbsp;<?php echo $fname; ?></option>
											<?php
										}
									}
									?>
                            ...
                            <label for="inputAddress">Name</label>
                                <input type="text" class="form-control" id="inputAddress" <?php if(isset($name)){ ?> value="<?php echo $name; ?>" <?php } ?> name="name" pattern="[A-Za-z]+"  placeholder="Name">
                             </div> 
								</div>								
							<div class="form-row">
                            <div class="col-md-4 mb-4">
                                    <label for="validationCustom03">Account Number</label>
                                    <input type="text" class="form-control" id="validationCustom03" name="accno" pattern="[0-9]{9,18}" placeholder="Account number" required  <?php if(isset($accno)){ ?> value="<?php echo $accno; ?>" <?php } ?> >
							...
							<div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom05" name="salary" pattern="[0-9]{4,5}" placeholder="salary" required>
                                    <div class="valid-feedback">
						...
						if(isset($_POST['save']))
{
	...
	$query = "insert into add_salary(name,accno,dop,salary,dippoid) values('".$name."','".$accno."','".$dop."','".$salary."','".$dippo."')";
