                        ...
                        <form class="needs-validation" action="#" method="post">
                            <div class="form-row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" name="lname" pattern="/^[A-Za-z-,]+(\s{0,1}[a-zA-Z-, ]*$/" placeholder="Last name" 
                                   option>
                                </div>
								<div class="col-md-2">
							...
							<div class="form-row">
							    <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="inputEmail4" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,4}$" placeholder="Email" option>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Password</label>
                                    <input type="password" class="form-control" id="inputPassword4" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Password" option>
                                </div>
                            </div>
                            <div class="form-row">
							<div class="col-md-6 mb-6">
                                    <label for="validationCustom03">Phone Number</label>
                                    <input type="text" class="form-control" id="validationCustom03" name="phone_no" pattern="[0-9]{10}" placeholder="Phone number" required />
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <input type="text" class="form-control" id="inputZip" name="pincode" pattern="[0-9]{6}" placeholder="Pin code" required />
                                </div>
                            </div>
							<br>
							...
							<div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="no_cattle" pattern="[0-9]{1,2}" required />
                               ...
                               <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="no_insured_cattles" pattern="[0-9]{1,2}" required />
							...
							<div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" name="accno" pattern="[0-9]{9,18}" placeholder="Account number" required />
                                    
                                </div>
                                <div class="col-md-6 mb-6">
                                    <label for="validationCustom02">IFSC Code</label>
                                    <input type="text" class="form-control" id="validationCustom02" name="ifsc_code" pattern="^[A-Z]{4}0[A-Z0-9]{6}$" placeholder="IFSC" required />
					   ...
					   <div class="form-row">
								<div class="form-group col-md-6">
                                    <label for="inputState">Bank</label>
                                     <input type="text" class="form-control" id="validationCustom02" name="bank" pattern="/^[A-Za-z-,]+(\s{0,1}[a-zA-Z-, ]*$/" >
...
if(isset($_POST['save']))
{
	...
	else
	{
		...
		if ($_POST['no_cattle'] >= $_POST['no_insured_cattles']) {
		...
		echo "<script>
			...
			echo "<script>
					alert('No.of Cattles Not Equal or greater than Insured cattle .');
				</script>";
		}
	}
}
