						...
						if(isset($_GET['edid']))
							...
							<div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="acc_no" value="<?php echo $acc_no; ?>"class="form-control" id="validationCustom01" pattern="[0-9]{9,18}"  placeholder="Account number" required>
                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" name="ifsc_code" value="<?php echo $ifsc_code; ?>"  class="form-control" id="validationCustom02" placeholder="IFSC"  pattern="^[A-Z]{4}0[A-Z0-9]{6}$"  required>
                                    <div class="valid-feedback">
						 ...
						 <div class="form-row">
								<div class="form-group col-md-6">
                                    ...
                                    <select id="inputState" name="bank" value="<?php echo $bank; ?>" pattern="[A-Za-z]+" class="form-control">
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update add_staff set acc_no='".$acc_no."',ifsc_code='".$ifsc_code."',bank='".$bank."' where s_id='".$eid."'";
		...
		echo "<script>
			...
			echo "<script> location.href='viewbank.php'; </script>";
