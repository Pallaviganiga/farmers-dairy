						...
						if(isset($_GET['edid']))
							{
								$eid=$_GET['edid'];
								include 'config.php';
								$sql1 = "select * from add_feed where f_id='".$eid."'";
                            ...
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="name" class="form-control" value="<?php echo $name;?>" id="validationCustom01" placeholder="Name" required>
								...
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="rate" class="form-control" value="<?php echo $rate;?>" id="validationCustom02" placeholder="rate" pattern="[0-9]{1,3}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								...
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="qty" class="form-control" value="<?php echo $qty;?>" id="validationCustom02" placeholder="qty" pattern="[0-9]{1,3}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    <label for="validationCustom02">Subcidy</label>
                                    <input type="text" name="subcidy" class="form-control" value="<?php echo $subcidy;?>" id="validationCustom02" placeholder="subcidy" pattern="[0-9]{1,3}" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$qty=$_POST['qty'];
		$subcidy=$_POST['subcidy'];
		
		
		$query = "update add_feed set name='".$name."',rate='".$rate."',qty='".$qty."',subcidy='".$subcidy."' where f_id='".$eid."'";
		...
		echo "<script>
			...
			echo "<script> location.href='editfood.php?edid=$eid'; </script>";
