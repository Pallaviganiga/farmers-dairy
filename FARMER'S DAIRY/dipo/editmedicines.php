						...
						if(isset($_GET['edid']))
							{
								$eid=$_GET['edid'];
								include 'config.php';
								$sql1 = "select * from medicine where mid='".$eid."'";
                        ...
                        <form class="needs-validation" action="#" method="post">
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $mname;?>" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{5,12}$" placeholder="Name" name="mname" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="rate" class="form-control" value="<?php echo $rate;?>"  pattern="[0-9]{3}" placeholder="rate" required>
                                    <div class="valid-feedback">
                                        Rate!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="number" name="qty" class="form-control" value="<?php echo $qty;?>" pattern="[0-9]+" placeholder="rate" required>
                                    <div class="valid-feedback">
                                        Quantity!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" name="descr" class="form-control" value="<?php echo $descr;?>"  pattern="[A-Za-z]+" placeholder="Description" required>
                                    <div class="valid-feedback">
                                       Description!
                                    </div>
                                </div>
								<!--<div class="col-md-3">
                                    ...
                                    <input type="file" name="image" class="form-control" id="validationCustom02" placeholder="subsidy" required>
                                    <div class="valid-feedback">
                                        Image!
                                    </div>
                                </div>-->
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update medicine set mname='".$mname."',descr='".$descr."',rate='".$rate."',qty='".$qty."' where mid='".$eid."'";
		...
		echo "<script>
			...
			echo "<script> location.href='editmedicines.php?edid=$eid'; </script>";
                ...
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            ...
                            <button type="submit" class="btn  btn-success">Back</button></a>
							</div>
							</div>
                    </div>
                </div>
