						...
						if(isset($_GET['edid']))
                            ...
                            <div class="form-row">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" name="fname" value="<?php echo $fname; ?>" class="form-control" id="validationCustom01" pattern="[A-Za-z]+" placeholder="First name" required>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="text" name="lname" value="<?php echo $lname; ?>" class="form-control" id="validationCustom02" pattern="[A-Za-z]+" placeholder="Last name" required>
                                </div>
								<div class="col-md-2">
							...
							<div class="form-row">
							    <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,4}$" value="<?php echo $email; ?>" class="form-control" id="inputEmail4" placeholder="Email">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Password</label>
                                    <input type="text" name="password" value="<?php echo $password; ?>" class="form-control" id="inputPassword4" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Password">
                                </div>
                            </div>
                            <div class="form-row">
							<div class="col-md-6 mb-6">
                                    <label for="validationCustom03">Phone Number</label>
                                    <input type="text" name="phone_no" value="<?php echo $phone_no; ?>"class="form-control" id="validationCustom03" pattern="[0-9]{10}" placeholder="Phone number" readonly > 
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="city" value="<?php echo $city; ?>" class="form-control" id="inputCity" pattern="[0-9]{100}" placeholder="City">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="inputState">State</label>
                                    <select id="inputState" name="state" value="" pattern="[0-9]+" class="form-control">
							...
							<div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="no_cattle" value="<?php echo $no_cattle; ?>" class="form-control" id="validationCustom01" pattern="[0-9]{1,2}" required>
                                    <div class="valid-feedback">
                               ...
                               <div class="col-md-3">
                                    ...
                                    <input type="text" name="no_insured_cattle" value="<?php echo $no_insured_cattle; ?>"class="form-control" id="validationCustom01" pattern="[0-9]{1,2}"  required>
							...
							<div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="accno" value="<?php echo $accno; ?>" class="form-control" id="validationCustom01" pattern="[0-9]{18}" placeholder="Account number" required>
                                    <div class="valid-feedback">
                                ...
                                <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" name="ifsc_code" value="<?php echo $ifsc_code; ?>" class="form-control" id="validationCustom02" pattern="^[A-Z]{4}0[A-Z0-9]{6}$" placeholder="IFSC" required>
                                    <div class="valid-feedback">
						 ...
						 <div class="form-row">
								<div class="form-group col-md-6">
                                    ...
                                    <select id="inputState" name="bank" value="<?php echo $bank; ?>" pattern="[0-9]{9,18}"class="form-control">
