                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Salary Details</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
								...
								<?php
								include 'config.php';
							 $sql1="select * from add_salary where dippoid='$dippo'";
							 //$sql1="select * from add_salary where dippoid='D003'";
							 ...
							 <a href="editsalary.php?edid=<?php echo $s_id; ?>">
