...
<section id="center" class="center_o clearfix">
 <div class="container">
   <div class="row">
     ...
     <div class="col-sm-12">
	  <h2 class="col_4">Veterinary Doctor</h2>
...
<section id="team_h">
 <div class="container">
  <div class="row">
   ...
   <?php
								include 'config.php';
								$sql1="select add_doctor.*,add_user.* FROM add_doctor INNER JOIN add_user ON add_doctor.dippoid=add_user.dippoid where add_user.phone_no='".$user1."'";
								...
								if($num1>0)
								{
									while($row1=mysqli_fetch_array($result1))
									{
										...
										$opening_time=$row1['opentm'];
										$closing_time=$row1['closetm'];
    ...
    <div class="col-sm-3 space_left">
	 <div class="team_h2i clearfix">
				...
				<h5><?php echo $name; ?></h5>
				<h6><?php echo $address1; ?></h6>
				<h6><?php echo $phoneno; ?></h6>
				<h6><?php echo $opening_time; ?> AM To <?php echo $closing_time; ?> PM</h6>
