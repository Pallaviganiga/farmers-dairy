                        ...
                        <form class="needs-validation" novalidate action="#" method="post">
							...
							<div class="form-row">
							    <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,4}$" placeholder="Email" required>
                                </div>
                                <div class="form-group col-md-6">
							...
							<div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" name="ph_no" pattern="[0-9]{10}" placeholder="Phone number" required>
                                    
                                </div>
								<div class="col-md-6 mb-6">
                                <label for="inputAddress">Address</label>
                                <input type="text" class="form-control" id="inputAddress" name="address" pattern="{100}"  placeholder="Address" required>
                            </div>
							</div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
						...
						if(isset($_POST['register']))
{
	...
	else
	{
		...
		$query = "insert into dipo_reg(dnumber,dname,email,password,ph_no,address,city,pin_code) values('".$dippono."','".$dname."','".$email."','".$password."','".$ph_no."','".$address."','".$city."','".$pincode."')";
