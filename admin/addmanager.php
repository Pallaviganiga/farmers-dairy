			...
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-align-justify"></i></span><span class="pcoded-mtext">Add Manager Details</span></a>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                       ...
                       <h5 class="mt-5">Manager Register</h5>
                        <hr>
                        <form class="needs-validation" novalidate action="#" method="post">
                            <div class="form-row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" name="lname" pattern="[A-Za-z]+" placeholder="Last name" option />
                                    
                                </div>
								<div class="col-md-2">
                                    <label for="validationCustom02">Dippo Id</label>
									<select class="form-control"  name="dippoid">
									<?php
								include 'config.php';
								...
								if($num1>0)
								{
									while($row1=mysqli_fetch_array($result1))
									{
										...
										$dname=$row1['dname'];
								?>
									<option value="<?php echo $dnumber; ?>"><?php echo $dnumber; ?>(<?php echo $dname; ?>)</option>
									<?php
									}
								}
								?>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="inputState" name="state" pattern="[A-Za-z]+" class="form-control">
						...
						if(isset($_POST['save']))
{
	...
	$sql = "select * from add_manager where email='$email' or phoneno='$phoneno'";
	...
	if($count>0)
	{
		...
		echo "<script>
			...
			echo "<script> location.href='viewmanager.php'; </script>";
	}
	else
	{
		$fname=$_POST['fname'];
		$lname=$_POST['lname'];
		$dippoid=$_POST['dippoid'];
		$email=$_POST['email'];
		...
		$query = "insert into add_manager(fname,lname,dippoid,email,password,phoneno,address,city,state,pin_code) values('".$fname."','".$lname."','".$dippoid."','".$email."','".$password."','".$phoneno."','".$address."','".$city."','".$state."','".$pincode."')";
