                        ...
                        <div class="col-sm-6 card-body br">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                   <h5><?php
								include 'config.php';
								$sql1="select sum(liter) from add_milk";
                        ...
                        <div class="col-sm-6 card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                    <h5><?php
								include 'config.php';
								$sql1="select sum(fat) from add_milk";
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								if($num1>0)
                        ...
                        <div class="col-sm-6 card-body br">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
									...
									<?php
								include 'config.php';
								$sql1="select sum(no_cattle) from add_user";
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								if($num1>0)
                        ...
                        <div class="col-sm-6 card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-md-center">
                                     <h5><?php
								include 'config.php';
								$sql1="select sum(no_insured_cattles) from add_user";
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								if($num1>0)
                 ...
                 <div class="card flat-card">
						...
						<div class="card flat-card widget-primary-card">
							<div class="row-table">
								...
								<div class="col-sm-6">
									<h4><?php
								include 'config.php';
								$sql1="select sum(qty) from add_feed";
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								if($num1>0)
						...
						<div class="card flat-card widget-purple-card">
							<div class="row-table">
								...
								<div class="col-sm-9">
									<h4><?php
								include 'config.php';
								$sql1="select sum(qty) from medicine";
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								if($num1>0)
                    ...
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
							...
							<?php
								include 'config.php';
								$sql11="select sum(ostar) from feedback";
			 ...
			 <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php 
					include 'config.php';
					 $sql12 ="select sum(liter), date from add_milk group by month(date)";
         $result12= mysqli_query($con,$sql12);
         $chart_data="";
         while ($row12 = mysqli_fetch_array($result12)) { 
 
            $month[]  = date_format(date_create( $row12[1]),"M d, Y")  ;
            $sales[] = $row12[0];
        }

					?>
			<div style="width:100%;hieght:20%;text-align:center">
            <h2 class="page-header" >Month-wise Analytics Of Collected Milk Details. </h2>
			<h5>x-axis : Months		, y-axis : Liters</h5>
