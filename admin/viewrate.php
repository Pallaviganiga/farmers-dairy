                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">View Rate Details</h5>
                        </div>
                        <ul class="breadcrumb">
                            ...
                            <table class="table table-hover">
								...
								if($num1>0)
								{
									while($row1=mysqli_fetch_array($result1))
									{
										...
										?>
                                    <tr>
									<td style="background-color:#cfd4ff">FAT/SNF</td>
										<?php
								...
								if($num2>0)
								{
									...
									?>
                                       ...
                                       <td style="background-color:#cfd4ff"><?php echo $snf; ?></td>
									   <?php
									}
								}
								?>
								...
								<tr>
								<td style="background-color:#cfd4ff"><?php echo $fat; ?></td>
								<?php
								$sql3="select * from add_rate where fat='$fat'";
