                        ...
                        <form class="needs-validation" action="#" method="post">
                            <div class="form-row">
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="dname" pattern="/^[A-Za-z-,]+(\s{0,1}[a-zA-Z-, ]*$/" placeholder="Doctor Name" required>
								...
								<div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" name="contact" pattern="[0-9]{10}" placeholder="contact no" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
...
if(isset($_POST['add']))
{
	...
	else
	{
		...
		$query = "insert into add_doctor(name,address1,phoneno,opentm,closetm,dippoid) values('".$dname."','".$address1."','".$contact."','".$opntm."','".$clstm."','".$dippo."')";
