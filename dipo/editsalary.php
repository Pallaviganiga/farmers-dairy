                       ...
                       <h5 class="mt-5">Staff Salary</h5>
						...
						if(isset($_GET['edid']))
							{
								$eid=$_GET['edid'];
								include 'config.php';
								$sql1="select * from add_salary where sal_id='$eid'";
                        ...
                        <form class="needs-validation" action="#" method="post">
                            ...
                            <div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" name="name" class="form-control"  value="<?php echo $name; ?>" placeholder="Staff Name" required readonly>
                                    
                                </div>
								
                                <div class="col-6 md-6">
								  <label for="validationCustom01">Account Number</label>
                                    <input type="text" name="accno" value="<?php echo $accno; ?>" class="form-control"  pattern="[0-9]{9,18}" placeholder="Account number" required readonly>
                                   
                                </div>    
								
                                <div class="col-md-6">
                                    <label for="validationCustom03">Date Of Payment</label>
                                    <input type="date" name="dop" value="<?php echo $dop; ?>" class="form-control"  required readonly>
								...
								<div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $salary; ?>" name="salary" placeholder="salary" required>
                                    <div class="valid-feedback">
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update add_salary set name='".$name."',accno='".$accno."',dop='".$dop."' ,salary='".$salary."' where sal_id='".$eid."'";
