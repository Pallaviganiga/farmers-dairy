                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Edit Staff Details</h5>
                        </div>
             ...
             <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                       ...
                       <h5 class="mt-5">Staff Details Edit</h5>
                        <hr>
						<?php
						if(isset($_GET['edid']))
							{
								$eid=$_GET['edid'];
								include 'config.php';
								$sql1 = "select * from add_staff where s_id='".$eid."'";
                        ...
                        <form action="#" method="post" class="needs-validation" novalidate>
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="lname" value="<?php echo $lname; ?>" class="form-control" id="validationCustom02" pattern="/^[A-Za-z-,]+(\s{0,1}[a-zA-Z-, ]*$/" placeholder="Last name" option>
							...
							<div class="col-md-6 mb-6">
                                    ...
                                    <input type="text" name="phno" value="<?php echo $phno; ?>"class="form-control" id="validationCustom03" pattern="[0-9]{10}" placeholder="Phone number" required>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="city" value="<?php echo $city; ?>  "class="form-control" pattern="/^[A-Za-z-,]+(\s{0,1}[a-zA-Z-, ]*$/" placeholder="City">
                                </div>
                                
                                <div class="form-group col-md-4">
                                    <label for="inputZip">Pin Code</label>
                                    <input type="text"  name="pin_code" value="<?php echo $pin_code; ?>  "class="form-control" pattern="[0-9]{6}" placeholder="Pin code">
                                </div>
								<div class="form-group col-md-4">
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update add_staff set fname='".$fname."',lname='".$lname."',phno='".$phno."',address='".$address."',city='".$city."' ,pin_code='".$pin_code."',designation='".$designation."' where s_id='".$eid."'";
