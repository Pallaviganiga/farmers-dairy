                        ...
                        <form class="needs-validation" action="#" method="post" enctype="multipart/form-data">
                            <div class="form-row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Desc.." name="description" required>
                                    <div class="valid-feedback">
                                        Description!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Rate" name="rate"  pattern="[0-9]{1,3}" required />
                                    <div class="valid-feedback">
                                       Rate!
                                    </div>
                                </div>
								...
								<div class="col-md-3">
									...
									<input type="text" class="form-control" id="validationCustom02" placeholder="Quantity" name="qty" pattern="[0-9]{1,3}" required/>
                                    <div class="valid-feedback">
                                        Available Quantity!
                                    </div>
                                </div>
								<div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Subcidy Amount" name="subcidy" pattern="[0-9]{1,3}" required />
                                    <div class="valid-feedback">
                                        Subcidy Amount!
                                    </div>
                                </div>
...
if(isset($_POST['add']))
{
	...
	include("config.php");
		...
		$query = "insert into add_feed(name,description,rate,image,qty,subcidy,dippoid) values('".$name."','".$description."','".$rate."','".$filename."','".$qty."','".$subcidy."','".$dippo."')";
