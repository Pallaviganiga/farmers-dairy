                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">View Milk Details</h5>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
								include 'config.php';
								$sql1="select * from add_milk where dippoid='".$dippo."' group by user_no";
								...
								?>
									<tr>
										...
										<td><?php echo $name; ?></td>
										<td><a href="viewmore.php?uno=<?php echo $user_no; ?>"> <button type="submit" class="btn  btn-primary">More</button></a></td>
                                     </tr>
                                     <?php
									}
								}
