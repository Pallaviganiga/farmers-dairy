                ...
                <div class="card">
                    <div class="card-header">
						...
						<?php
								...
								include 'config.php';
								$sql1="select * from add_milk where user_no='".$uno."' group by user_no";
                    ...
                    <div class="card-body table-border-style">
                        <div class="table-responsive">
                            <table class="table table-hover">
							   ...
							   {
								   $date3=$_POST['date3'];
								   $sql1="select * from add_milk where user_no='".$uno."' and date='".$date3."'";
							   }
							   else if(isset($_POST['search']))
							   {
								   $date1=$_POST['date1'];
								   $date2=$_POST['date2'];
								   $sql1="select * from add_milk where user_no='".$uno."' and date between '".$date1."' and '".$date2."'";
							   }
							   else
							   {
								   $sql1="select * from add_milk where user_no='".$uno."'";
							   }
								$result1=mysqli_query($con,$sql1);
								$num1=mysqli_num_rows($result1);
								$sI=0;
								...
								?>
									...
									<td><?php echo round($totalamt,2) ; ?></td>
                                    </tr>
								...
								include 'config.php';
								$sql2="select sum(totalamt) as tot from add_milk where user_no='".$uno."' group by user_no";
								...
								?>
									...
									{
									$sql2="select sum(totalamt) as tot from add_milk where user_no='".$uno."' and date between '".$date1."' and '".$date2."'";
									}
									
									if(isset($_POST['search1']))
									{
									$sql2="select sum(totalamt) as tot from add_milk where user_no='".$uno."' and date='".$date3."'";
									}
								$result2=mysqli_query($con,$sql2);
								$num2=mysqli_num_rows($result2);
								if($num2>0)
							...
							<div class="form-row">
								<div class="form-group col-md-4">
                                    <label for="inputEmail4">Grand Total amount</label>
                                    <input type="hidden" class="form-control" name="totalamt" readonly  />
                                </div>
								</div>
							</form>
							<div class="form-row">
							
							 <div class="form-group col-md-2"><a href="viewmilkd.php">
                            <button type="submit" class="btn  btn-primary">BACK</button></a>
							</div>
							<div class="form-group col-md-2">
							<a href="printbill1.php?uno=<?php echo $user_no; ?>"> 
                            <button type="submit" class="btn  btn-primary">Bill</button></a>
							</div>
