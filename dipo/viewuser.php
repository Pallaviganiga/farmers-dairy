                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
								...
								?>
									...
									<td><a href="viewuser_details.php?mid=<?php echo $u_id; ?>"> <button type="submit" class="btn  btn-primary">More</button></a></td>
									<td>

									<div class="form-row">
							 <div class="form-group col-md-2">
							 <a href="edituser.php?edid=<?php echo $u_id; ?>">
                            <button type="submit" name="edit" class="btn  btn-primary">Edit</button></a>
									...
									<div class="form-row">
									<div class="form-group col-md-2">
									<input type="text" name="did[]" value="<?php echo $u_id; ?>" hidden="true">
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from add_user where u_id='".$selectid."'";
