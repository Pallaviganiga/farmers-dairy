...
<section id="center" class="center_o clearfix">
 <div class="container">
   <div class="row">
     ...
     <div class="col-sm-12">
	  <h2 class="col_4">Cattle Feeds</h2>
	  <hr class="hr_1">
...
<section id="team_h">
 <div class="container">
  <div class="row">
   ...
   <?php
								include 'config.php';
								$sql1="select add_feed.*,add_user.* FROM add_feed INNER JOIN add_user ON add_feed.dippoid=add_user.dippoid where add_user.phone_no='".$user1."'";
		...
		<div class="team_h2i1 clearfix">
			<div class="grid clearfix">
		         <figure class="effect-jazz">
			          <a href="#"><img src="../dipo/image/<?php echo $image; ?>" class="iw" alt="img25" style="border: 2px solid black; width: 270px;height:400px;margin-right: 30px; margin-bottom: 30px;"></img></a>
		           </figure>
	          </div>
			</div>
   ...
   <div class="footer_1 clearfix">
	 <div class="col-sm-4 space_left">
	  <div class="footer_1i clearfix">
	    <h2 class="mgt big"><img src="img/logo1.png" height="50px" class="iw1"  alt="img25"></h2>
